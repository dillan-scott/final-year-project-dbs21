\begin{table}
\caption{Baseline (no attack) per-day metrics for the static reference and the full system. $F_1$ is measured against a fixed novel-class-aware benchmark and false-negative rate is measured for each novel class.}
