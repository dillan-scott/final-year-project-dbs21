\begin{table}
\caption{Friday end-of-stream attack effect metrics on the full coupled system (\textsc{AdaptiveDAdaptiveM}). \textsc{StaticMStaticD} floor metrics under no attack are shown for reference. Values are mean $\pm$ std across three seeds.}
\label{tab:attack-fri-summary}
\resizebox{\textwidth}{!}{
\begin{tabular}{llrrrr}
\toprule
 & & Friday $F_1$ & Fri FNR(\texttt{DoS}) & Fri FNR(\texttt{PS}) & Retrains \\
System & Poison \% &  &  &  & \\
\midrule
\textsc{StaticDStaticM} & 0 & 0.207 $\pm$ 0.000 & 0.881 $\pm$ 0.000 & 0.999 $\pm$ 0.000 & 0 \\
