\begin{table}
\caption{Friday end-of-stream attack effect metrics on the full coupled system (\textsc{AdaptiveDAdaptiveM}). \textsc{StaticDStaticM} floor metrics under no attack are shown for reference. Values are mean $\pm$ std across three seeds.}
