...
\todo[color=blue!80!white, textcolor=white]{Rewrite declarations chapter}
...
From a legal perspective, this project is conducted in strict accordance with the \emph{Computer Misuse Act 1990 (UK)}. Section 3 of the Act prohibits unauthorised acts with the intent to impair the operation of a computer. 
\begin{itemize}
